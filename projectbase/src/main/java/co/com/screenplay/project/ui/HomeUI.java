...
//7
//Define constantes estáticas para representar elementos de la interfaz de usuario de la página principal
public class HomeUI extends PageObject {        // hereda propiedades y métodos de PageObject
